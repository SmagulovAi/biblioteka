  ...
  <body>
    ...
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        <li><a href="/book" class="nav-link px-2 link-secondary">Главная</a></li>
      ...
      @auth
        <div class="col-md-3 text-end">
          <a href="/logout" class="btn btn-outline-primary me-2">Выход</a>
  ...
  <div class="album py-5 bg-body-tertiary">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <a href="{{ route ('card', $book->id) }}" class="btn btn-sm btn-outline-secondary">Читать</a>
    ...
    <footer class="text-body-secondary py-5">
        ...
        <div class="container">
            ...
            <p class="mb-0"><a href="/book">Вернуться на главную</a></p>
        </div>
    </footer>
